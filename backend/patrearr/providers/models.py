...
@dataclass
class CreatorInfo:
    """A creator/campaign/profile as the provider describes it."""
...
class SubscriptionInfo:
    """Something the account is subscribed/pledged to."""
...
@dataclass
class PostResource:
    """A post in normalised form. Provider-specific extras stay in `raw`."""
    ...
    def storable_json(self) -> dict[str, Any]:
        """What we persist as raw_json / post.json."""
