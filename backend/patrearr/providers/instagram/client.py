...
themselves are downloaded through Patrearr's own pipeline. Instagram requires a
...
from patrearr.providers.errors import AuthError, NotFoundError, ProviderError
