...
class NotificationService:
    ...
    async def test(self) -> dict[str, Any]:
        ...
        await self._dispatch("Test notification", "Creeparr notifications are working.", "info")
