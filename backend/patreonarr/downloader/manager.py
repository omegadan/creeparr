...
from patreonarr.core.state import get_state, set_state
...
from patreonarr.downloader.fs import free_space_bytes, remove_tree
...
from patreonarr.downloader.handlers.ytdlp import YtDlpOptions, normalise_vimeo_url, run_ytdlp
from patreonarr.downloader.queue import enqueue_media, publish_post_changed, recompute_post_status
from patreonarr.downloader.sidecars import write_text_sidecars
from patreonarr.patreon.drm import probe_hls_drm
...
class DownloadManager:
    ...
    def _finalise_ytdlp(
        ...
        from patreonarr.downloader.fs import atomic_replace, sha256_file
