...
3. Set **Config** (default `/mnt/user/appdata/creeparr`) and **Downloads** (default
   `/mnt/user/media/creeparr`). The per-provider download paths are optional; leave them
   blank to archive everything under **Downloads**. Click **Apply**.
...
Then open `http://<tower-ip>:7979`, go to **Settings**, and connect the providers you use
on their tabs (Patreon, OnlyFans, YouTube, Instagram, Reddit).
